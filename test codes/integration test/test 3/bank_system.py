...
def customer_login():
    ...
    for line in customer_file:
        ...
        if (customer_id == login_customer[0] and customer_pass == login_customer[4]):
            ...
            return "**!!!! Your Password or ID is wrong !!!!**"
...
def customer_withdraw():
    ...
    if (withdrawal_balance>0):
        if (current_balance>withdrawal_balance):
            ...
            return "!!! You Account balance is not enough to withdraw money try again !!!"
            customer_withdraw()
    else:
        print("!!!you entered invalied withdraw amount please try again!!!")
        return "!!!you entered invalied withdraw amount please try again!!!"
        customer_withdraw()
...
def customer_Account_balance():
    ...
    return "Current Balance : {0:.2f}".format(current_balance)
...
def  monthly_repayment_loan():
    ...
    return "The monthly repayment for a loan : {0:.2f}".format(monthlyPayments)
    ...
    if datetime.today().day == 30 or datetime.today().strftime("%m/%d") == '02/28':
        ...
        for line in customer_file:
            ...
            if (deposit_id == cust_deposit[0] and deposit_pass == cust_deposit[4]):
                ...
                return "*** your monthly interest is SUCSSESFULLY DEPOSITED!  try again next month ***"
            else:   
                print ("!!! You enter wrong ID or Password !!!")
                return "!!! You enter wrong ID or Password !!!"
                interest_deposits()
        ...
        return "!!!Sorry, you have used this months interest limit, try again next  time in 30th of the month and also using only February 28th!!!"
